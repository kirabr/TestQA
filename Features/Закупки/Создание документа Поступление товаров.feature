...
создавать документ Поступление товаров 
чтобы поставить товар на учёт
Контекст:
Дано Я открыл новый сеанс TestClient или подключил уже существующий 

Сценарий: Проверка создания документа прихода товаров
* Закрытие всех окон
	И я закрываю все окна клиентского приложения
* Открытие окна документа
...
Сценарий: проверка наличия номенклатуры "Торт" в справочнике номенклатуры
